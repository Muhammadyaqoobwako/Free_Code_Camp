...
let Title = React.createClass({ displayName: "Title",
  render: function () {
    ...
    return (
      ...
      React.createElement("h5", { className: codedByClass }, "Coded by ", React.createElement("a", { target: "_blank", href: "#" }, "Muhammad Yaqoob"))));
